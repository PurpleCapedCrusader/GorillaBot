                                            ...
                                            if (gameIs == "true") {
                                                turnIsInProgress(message).then((results) => {
                                                    ...
                                                    if (turnIs == true) {
                                                        ...
                                                        endTurn(message).then(new_roll_for_game(message));
                                                    }
                                                });
                                            } else {
                                                message.channel.send(`Once all players are in the voice channel, use the **!Bands**, **!College Courses**, **!Companies**, **!Food Trucks**, **!Movies**, **!Organizations**, or **!Products** command to start a game.`);
    ...
    (async () => {
        ...
        try {
            ...
            playersFromDatabase.rows.forEach((row) => {
                ...
                console.log(`playersFromDatabaseArray = ${JSON.stringify(playersFromDatabaseArray)}`)
            ...
            playersFromDatabaseArray.forEach(function (guildMember, guildMemberId) {
                console.log(`JSON.stringify(guildMember) = ${JSON.stringify(guildMember)}`);
